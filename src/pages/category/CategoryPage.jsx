...
const CategoryPage = () => {
    ...
    // Log the category name and all products
    console.log("Category:", categoryname);
    console.log("All Products:", getAllProduct);

    // Normalize the category names and filter products
    const normalizedCategoryName = categoryname.toLowerCase();
    const filterProduct = getAllProduct.filter((obj) => obj.category.toLowerCase().includes(normalizedCategoryName));
